...
WAGTAIL_SITE_NAME = 'Don Forrest Realty'

# Override the search results template for wagtailsearch
# WAGTAILSEARCH_RESULTS_TEMPLATE = 'listing/search_results.html'
# WAGTAILSEARCH_RESULTS_TEMPLATE_AJAX = 'listing/includes/search_listing.html'
...
WAGTAILADMIN_NOTIFICATION_FROM_EMAIL = 'raymond@philippinedev.com'
